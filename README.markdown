...
The current version of this gem (2.43.1) packages Selenium Standalone Server 2.43.1 - [http://selenium-release.storage.googleapis.com/2.43/selenium-server-standalone-2.43.1.jar](http://selenium-release.storage.googleapis.com/2.43/selenium-server-standalone-2.43.1.jar)
