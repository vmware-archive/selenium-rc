...
The current version of this gem (2.4.0) packages **Selenium Standalone Server 2.0 [rc3] ( [http://selenium.googlecode.com/files/selenium-server-standalone-2.0rc3.jar](http://selenium.googlecode.com/files/selenium-server-standalone-2.0rc3.jar) )**
